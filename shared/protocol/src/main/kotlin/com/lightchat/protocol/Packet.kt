...
data class Packet(
    ...
    companion object {
        const val MAGIC_NUMBER: Short = 0x4C43 // "LC"
        const val VERSION: Byte = 1
        const val HEADER_SIZE: Int = 16   // magic(2) + version(1) + cmd(1) + seq(8) + length(4)
        const val CRC_SIZE: Int = 4
        const val MIN_PACKET_SIZE: Int = HEADER_SIZE + CRC_SIZE // 20 bytes minimum
    }
}
