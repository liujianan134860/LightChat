...
| 模块 | 状态 | 功能 |
| --- | --- | --- |
| 好友 | ✅ | 搜索用户、好友申请、同意/拒绝、好友申请通知 |
| 群聊 | ✅ | 创建群聊、邀请成员、群成员列表、群系统提示 |
| 会话设置 | ✅ | 置顶、免打扰、隐藏、删除、标记未读 |
| 图片体验 | ✅ | 多图选择、拖动多选、预览编辑、全屏左右切换、保存到相册 |
| 转发 | ✅ | 单条转发、多选转发、合并转发、嵌套聊天记录 |
| 搜索 | ✅ | 全局搜索、单聊/群聊记录搜索、定位并高亮消息 |
| 本地缓存 | ✅ | 头像和图片优先本地缓存，URL 过期后刷新 |
| 性能 | ✅ | 开屏优化、会话列表分页、1 万条消息双向分页 |
| 工程化 | ✅ | `.gitignore`、CI、单元测试、测试文档、抓包说明 |
